...
<div class="sc-breadcrumbs breadcrumbs-overlay">
    ...
    <div class="breadcrumbs-text white-color">
        <h1 class="page-title">Schooling</h1>
        <ul>
            <li>
                <a class="active" href="{{route('home')}}">Home ></a>
            </li>
            <li class="active">Schooling</li>
        </ul>
    </div>
</div>
<!-- Title Section End -->
            ...
            <div class="courses-grid">
                ...
                <div class="content-part">
                    ...
                    <div class="bottom-part">
                        ...
                        <div class="btn-part">
                            <a href="{{route('schooling.course', $course->id)}}"><i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
                </div>
