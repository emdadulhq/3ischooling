						...
						<div class="tab-content tabs-content" id="myTabContent">
							...
							<div class="tab-pane fade" id="prod-reviews" role="tabpanel" aria-labelledby="course-reviews-tab">
								<div class="content pt-30">
                                    ...
                                    @foreach ($singleCourse -> comments as $singleComments)
                                    ...
                                    <div class="cource-review-box mb-30 ml-80 md-ml-0">
                                        ...
                                        @php
                                        $reply_comment = App\Models\Comments::where('comment_id','!=',null)->where('comment_id', $singleComments-> id)->get();
                                        @endphp
                                    ...
                                    <a href="#"  class="comment-reply-btn" c_id="{{$singleComments->id}}">Reply</a>
                                        ...
                                        <div style="display: none;" id="comment_reply_box"
                                            ...
                                            <form action=" {{ route('course.comment.reply') }}" class="comment-form" method="POST">
                                                @csrf
                                                <div class="form-group">
                                                    <input type="hidden" name="post_id" value="{{ $singleCourse->id }}">
                                            ...
                                            <div class="comment-area">
                                                <div class="comment-full">
                                                    <h3 class="reply-title">Add to Comment</h3>
                                                        <form action="{{ route('course.comment') }}" class="comment-form" method="POST">
                                                            @csrf
                                                            <div class="form-group">
                                                                <input type="hidden" name="post_id" value="{{ $singleCourse->id }}">
					...
					<div class="inner-column">
						<div class="course-features-info">
							...
							<ul>
								<li class="lectures-feature">
									...
									<span class="value">{{ $singleCourse->category->name }}</span>
								</li>
						...
						<div class="course-features-info">
							...
							<ul>
								...
								<li class="lectures-feature">
									<a href="{{route('course.category', $category->id)}}"><span class="label">{{$category-> name}}</span></a>
