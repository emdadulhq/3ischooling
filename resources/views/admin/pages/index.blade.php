			...
			<div class="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
				<div class="widget-card widget-bg1">
					<div class="wc-item">
						...
						<span class="wc-stats">
							<span class="counter">{{$countcourse->count()}}</span>
						</span>
				...
				<div class="widget-box">
					...
					<div class="widget-inner">
						<div class="new-user-list">
							<ul>
                                @foreach ($newuserlist as $userlist)


								<li>
									<span class="new-users-pic">
										<i class="fa fa-user-circle" aria-hidden="true" style="font-size: 40px; color:orange;"></i>
									</span>
									<span class="new-users-text">
										<a href="{{route('users.guest')}}" class="new-users-name">{{$userlist->name}} </a>
										<span class="new-users-info">{{$userlist->institute}} </span>
									</span>
							...
							<ul>
								<li>
									...
									<span class="notification-text">
										<span>{{ Auth::user()-> name }}</span> sent you a message.
									</span>
