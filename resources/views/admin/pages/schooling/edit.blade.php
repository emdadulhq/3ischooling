...
<main class="ttr-wrapper">
	<div class="container-fluid">
		<div class="db-breadcrumb">
			<h4 class="breadcrumb-title">Edit Schooling Course</h4>
			<ul class="db-breadcrumb-list">
				<li><a href="#"><i class="fa fa-home"></i>Home</a></li>
				<li>Edit Schooling Course</li>
			</ul>
		</div>
		<div class="container">
				...
				<div class="wrap shadow">
					<div class="card">
						<div class="card-body">
							...
							<form action="{{ route('admin.schooling.update', $course_edit->id) }}" method="POST" >
								@csrf
