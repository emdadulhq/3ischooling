...
<main class="ttr-wrapper">
	<div class="container-fluid">
		<div class="db-breadcrumb">
			<h4 class="breadcrumb-title">New Admission Course</h4>
			<ul class="db-breadcrumb-list">
				<li><a href="#"><i class="fa fa-home"></i>Home</a></li>
				<li>New Admission Course</li>
			</ul>
		</div>
		<div class="container">
					...
					<div class="card">
						<div class="card-body">
							...
							<form action="{{ route('admin.admission.store') }}" method="POST" >
								...
								<div class="form-group">
                                <label for="name">Course Subject</label>
                                <select name="subject" id="">
                                    <option value=""> </option>
                                    @foreach ($course_sub as $sub)
								...
								<div class="form-group">
                                    ...
                                    <a href="{{route('admin.admission')}}" class="btn btn-success">Back to list</a>
								</div>
							</form>
						</div>
					</div>
