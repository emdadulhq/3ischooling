	...
	<div class="ttr-sidebar">
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<div class="ttr-sidebar-logo">
				<a href="{{ route('admin.dashboard') }}"><img alt="" src="{{URL::to('assets/images/logo.png')}}" width="122" height="27"></a>
		...
		<div class="ttr-sidebar-wrapper content-scroll">
			<!-- side menu logo start -->
			<div class="ttr-sidebar-logo">
				<a href="{{ route('admin.dashboard') }}"><img alt="" src="{{URL::to('assets/images/logo.png')}}" width="82" height="27"></a>
				<!-- <div class="ttr-sidebar-pin-button" title="Pin/Unpin Menu">
					<i class="material-icons ttr-fixed-icon">gps_fixed</i>
					<i class="material-icons ttr-not-fixed-icon">gps_not_fixed</i>
				</div> -->
				...
				<ul>
					...
					<li>
						...
						<ul>
                            ...
                            <li>
                                <a href="{{ route('roles.index') }}" class="ttr-material-button"><span
                                        class="ttr-label">User
                                        Roles</span></a>
                            </li>
						</ul>
